...
func TestGPXInspectAPI(t *testing.T) {
	...
	input := `<gpx version="1.1" creator="test"><rte><name>R1</name><rtept lat="59" lon="10"/><rtept lat="59.01" lon="10"/></rte><trk><name>T1</name><trkseg><trkpt lat="60" lon="11"/><trkpt lat="60.01" lon="11"/></trkseg></trk></gpx>`
	...
	for _, want := range []string{`"version":"1.1"`, `"name":"R1"`, `"name":"T1"`, `"segments":1`, `"points":2`} {
